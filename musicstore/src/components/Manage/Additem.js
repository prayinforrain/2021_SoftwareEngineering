			...
			<form action="http://localhost:3001/upload" method="post" id="add_item_form" enctype="multipart/form-data">
				<div className="item_row">
					...
					<div className="item_row_field">
						<input type="text" id="album" placeholder="앨범명" />
					</div>
				</div>
				<div className="item_row">
					<div className="item_row_name">아티스트</div>
					<div className="item_row_field">
						<input type="text" id="singer" placeholder="아티스트" />
					</div>
				</div>
				<div className="item_row">
					<div className="item_row_name">배급사</div>
					<div className="item_row_field">
						<input type="text" id="supply" placeholder="배급사" />
					</div>
				</div>
				<div className="item_row">
				...
				<div className="item_row">
					...
					<div className="item_row_field">
						<textarea type="text" id="detail" placeholder="상세설명" />
					</div>
				</div>
				<div className="item_row">
