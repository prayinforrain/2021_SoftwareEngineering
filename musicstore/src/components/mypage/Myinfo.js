					...
					<table>
						<tbody>
							<tr>
								...
								<td>
									<input type="text" placeholder="ID" value={userInfo.ID} disabled />
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<input type="checkbox" value={userInfo.isAdult} disabled /> <button disabled>성인인증</button>
								</td>
							</tr>
							<tr>
								...
								<td>
									<label>
										<input type="radio" name="sex" value="male" checked={userInfo.Sex === 'male'} onChange={onChange} />
										남성
									</label>
									<label>
										<input
