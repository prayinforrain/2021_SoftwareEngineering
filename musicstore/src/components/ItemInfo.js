					...
					<div id="item_header">
						...
						<div id="item_header_info">
							...
							<div id="item_count_container">
								...
								/>
								<button className="item_count_btn" onClick={increaseCount}>
									+
								</button>
							</div>
							<div id="item_header_buy">
								<button id="item_add_wishlist" onClick={submitCart}>
									장바구니
								</button>
