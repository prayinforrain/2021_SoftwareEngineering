...
function WebRouter({ user, onLogout, openSignup, openLogin, openItemModal, closeItemModal }) {
	return (
		<Router>
			<Switch>
				...
				<Route exact path="/search/:genre/">
					<Header user={user} onLogout={onLogout} openSignup={openSignup} openLogin={openLogin} />
					<div id="main_container">
						<GenreSearch openItemModal={openItemModal} closeItemModal={closeItemModal} />
					</div>
					<Footer />
				</Route>
				...
				<Route exact path="/manage">
					<Managerpage openSignup={openSignup} openLogin={openLogin} />
				</Route>
				<Route path="/">
					<Mainpage
						user={user}
